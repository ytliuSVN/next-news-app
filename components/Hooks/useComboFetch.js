...
function useComboFetch() {
  ...
  useEffect(() => {
    ...
    // Top story
    const baseUrl_News = `${publicRuntimeConfig.GUARDIAN_API_URL}search?page-size=8&section=news&show-fields=body,headline,thumbnail&api-key=${publicRuntimeConfig.GUARDIAN_API_KEY}`;
